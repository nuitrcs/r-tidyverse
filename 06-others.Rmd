...
```{r}
mdy("1/13/2020","1/13/20", "01132020", "1-13-2020")
```
...
broom: convers the output of statistical modeling functions into tibbles.  Useful if you want to run a lot of regression models, t-tests, etc. and save all of the output in a standardized format.  
