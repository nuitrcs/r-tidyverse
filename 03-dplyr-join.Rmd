...
Join the cases data frame to the state_stats data frame using the state column in each (state in cases and State in state_stats);  case of the variable name matters!  ("state" is not equal to "State" as column names).
...
To see what columns are in demo (if filtering by missing values):
