...
install.packages("allisonhorst/palmerpenguins")
```
...
To change the axes min and max values, like we would with `xlim` or `ylim` in base R graphics, we have to use a scale function and set the `limits` argument:
